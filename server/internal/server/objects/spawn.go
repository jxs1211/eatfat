...
func SpawnCoords(radius float64, playersToAvoid *collection.SharedCollection[*Player], sporesToAvoid *collection.SharedCollection[*Spore]) (float64, float64) {
...
func isTooClose[T any](x float64, y float64, radius float64, objects *collection.SharedCollection[T], getPosition func(T) (float64, float64), getRadius func(T) float64) bool {
